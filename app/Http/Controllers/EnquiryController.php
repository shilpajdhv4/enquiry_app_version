...
//            echo "<pre>";print_r($enq_template);exit;
            return view('enquiry.add_enquiry',['enq_template'=>$enq_template]);//,['city'=>$city,'brand'=>$brand,'custome_data'=>$custome_data,'product_data'=>$product_data,'employee_data'=>$employee_data,'enquiry_status'=>$enquiry_status,'last_entry'=>$last_entry,'source'=>$source,'status'=>$status,'category'=>$category]);
        }else{
